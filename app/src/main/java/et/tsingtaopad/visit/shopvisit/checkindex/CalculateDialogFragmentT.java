 ...
 */
// 单项采集
public class CalculateDialogFragmentT extends DialogFragment implements OnClickListener {
     ...
     *
     */
    public static CalculateDialogFragmentT getInstance(ProIndexValue indexValue,
                                                       List<ProItem> tempLst) {
        CalculateDialogFragmentT dialog = new CalculateDialogFragmentT();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
       ...
       View view = LayoutInflater.from(getActivity()).inflate(R.layout.checkindex_calculatedialog, null);
        // View view = LayoutInflater.from(getActivity()).inflate(R.layout.checkindex_calculate_puhuo, null);// 铺货
        initView(view);
        initDate();
    ...
    private void initDate() {
        ...
        //calculateDialogLv.setAdapter(new CalculateIndexItemAdapter(getActivity(), tempLst));
