...
public class SpinnerLineCardAdapter extends BaseAdapter {

	private List<MstRouteMStc> mList = null;
	private Context mContext = null;

	public  SpinnerLineCardAdapter(Context pContext, List<MstRouteMStc> pList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.itemTv.setText(mList.get(position).getRoutename());
