 ...
 */
public class DayWorkingActivity extends Activity implements OnClickListener, OnCheckedChangeListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	setContentView(R.layout.operation_day_activity);
    	initView();
        initData();
    ...
    private void initView()
    {
        ...
        weekTv = (TextView) findViewById(R.id.weekwork_tv_week);
        weekBt = (Button) findViewById(R.id.weekwork_bt_week);
        dayPrevTv = (TextView) findViewById(R.id.weekwork_tv_day_prev);
        dayPrevBt = (Button) findViewById(R.id.weekwork_bt_day_prev);
        searchBt = (Button) findViewById(R.id.weekwork_bt_search);
        tagRg = (RadioGroup) findViewById(R.id.weekwork_rg_tag);
        workReportLl = (LinearLayout) findViewById(R.id.weekwork_ll_work);
        remarkLl = (LinearLayout) findViewById(R.id.weekwork_ll_remark);
        summaryLl = (LinearLayout) findViewById(R.id.weekwork_ll_summary);
        
        workReportWv = (WebView) findViewById(R.id.weekwork_web_workreport);
        remarkDateTv = (TextView) findViewById(R.id.weekwork_tv_remarkdate);
        remarkEt = (EditText) findViewById(R.id.weekwork_et_remark);//工作点评
        summaryDateTv = (TextView) findViewById(R.id.weekwork_tv_summarydate);
        summaryEt = (EditText) findViewById(R.id.weekwork_et_summary);//偏差分析
        submitBt = (Button) findViewById(R.id.weekwork_bt_submit);
        
        //scroll_view = (ScrollView) findViewById(R.id.owd_ll_scrollview);
                
        bfzdjs = (CheckBox) findViewById(R.id.owd_bfzdjs);
        zdywtj = (CheckBox) findViewById(R.id.owd_zdywtj);
        sdhtj = (CheckBox) findViewById(R.id.owd_sdhtj);
        sdhhg = (CheckBox) findViewById(R.id.owd_sdhhg);
        
        zdhztjwh = (CheckBox) findViewById(R.id.owd_zdhztjwh);
        cxhdtj = (CheckBox) findViewById(R.id.owd_cxhdtj);
        sczbsd = (CheckBox) findViewById(R.id.owd_sczbsd);
        sczbbz = (CheckBox) findViewById(R.id.owd_sczbbz);
        
        wjjp = (CheckBox) findViewById(R.id.owd_wjjp);
        dddc = (CheckBox) findViewById(R.id.owd_dddc);
        jpsczb = (CheckBox) findViewById(R.id.owd_jpsczb);// 竞品市场指标
        zdkc = (CheckBox) findViewById(R.id.owd_zdkc);// 终端库存
        ...
        /*workReportWv.setOnTouchListener(new View.OnTouchListener() {
        ...
        //workReportWv.setOnScrollChangedCallback(DayWorkingActivity.this); 
        /*workReportWv.setOnTouchListener(new OnTouchListener() {
    ...
    {
        service = new WorkingService(DayWorkingActivity.this, handler);
        ...
        case R.id.banner_navigation_rl_back:
            ...
            case R.id.weekwork_bt_submit:
                ...
                if(str==null || str.equals("")){
                    ViewUtil.sendMsg(DayWorkingActivity.this, R.string.daywork_msg_summary);
                    return;
                }else {
        ...
        new DatePickerDialog(DayWorkingActivity.this,R.style.dialog_date, new DatePickerDialog.OnDateSetListener()
        {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth)
            {
                ...
                if (btId == R.id.weekwork_bt_week)//当天
                {
                    ...
                    {
                        ViewUtil.sendMsg(DayWorkingActivity.this, R.string.daywork_msg_currdate);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        ViewUtil.sendMsg(DayWorkingActivity.this, R.string.daywork_msg_prevdate);
                    }
                    else
                    {
    ...
    private void search()
    {
        ...
        */
        ...
        //urlBuffer.append(ConstValues.loginSession.getGridId());
        urlBuffer.append(PrefUtils.getString(DayWorkingActivity.this, "gridId", ""));
