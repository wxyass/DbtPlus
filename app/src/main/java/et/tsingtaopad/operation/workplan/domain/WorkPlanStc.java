...
public class WorkPlanStc {
	 ...
	 * @param date
	 */
	public WorkPlanStc(String visitTime, String visitStartDate, String visitEndDate, String operation, int state, String planKey, Date date) {
		super();
		this.visitTime = visitTime;
		this.setVisitStartDate(visitStartDate);
		this.setVisitEndDate(visitEndDate);
