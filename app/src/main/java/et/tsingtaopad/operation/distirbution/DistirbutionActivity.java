...
public class DistirbutionActivity extends BaseActivity implements OnClickListener, OnItemSelectedListener {
    ...
    private void initView() {
        ...
        lineSp = (Button) findViewById(R.id.distirbution_sp_line);
        ...
        lineSp.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.distirbution_bt_time:// 截止时间
            ...
            case R.id.distirbution_bt_query:// 查询
                this.search(true);
                break;
            //选择路线
            case R.id.distirbution_sp_line:
                List<MstRouteM> lineLst = new ArrayList<MstRouteM>(ConstValues.lineLst);
                if (CheckUtil.IsEmpty(lineLst)) {
                    lineLst = new ArrayList<MstRouteM>();
                } else {
                ...
                */
                // 路线
                DialogUtil.showMultipleDialog(this, lineSp, R.string.indexstatus_msg_line, lineLst, new String[]{"routekey", "routename"}, null, R.string.indexstatus_msg_line);
                break;
            //产品选择
            ...
            case R.id.distirbution_sp_minorchannel:
                ...
                for (String selectmainchanner : selectminorchanner) {//得到用来展示次渠道的父主键，主渠道键
                    for (KvStc selectmain : childKvStcList) {//在渠道类型里面找对应主键的下面的子级及子子级
    ...
    private void search(boolean isClick) {
        ...
        if (isClick) {
            ...
            lineId = FunUtil.isBlankOrNullTo(lineSp.getTag(), "");
            //选择时间
        ...
        submitBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (distirbutionCheckBox.isChecked()) {
                    ...
                    tiggerBt.setTag("0");
                } else {//2EA4CFE7E48746BC9E9079E5990D222E  04F569BFB355A4FDF8B740A9B4563D4E3
