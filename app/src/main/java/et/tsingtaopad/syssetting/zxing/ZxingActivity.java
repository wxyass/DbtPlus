...
public class ZxingActivity extends Activity {
	...
	private void initdata() {
		...
		create.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (content.getText().toString().equals("")) {
					...
					Toast.makeText(ZxingActivity.this, "不可输入空的内容", Toast.LENGTH_SHORT).show();
				} else {
					View view = LayoutInflater.from(ZxingActivity.this).inflate(R.layout.zxing_bitmapdialog, null);
					...
					new AlertDialog.Builder(ZxingActivity.this).setTitle("二维码").setView(view)
							.setPositiveButton("存至本地", new DialogInterface.OnClickListener() {
									...
									if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
										...
										if (true) {
											...
											try {
												...
												Toast.makeText(ZxingActivity.this, "图片成功存至myscan目录下", Toast.LENGTH_SHORT).show();
										...
										Toast.makeText(ZxingActivity.this, "SDCard存储空间不足", Toast.LENGTH_SHORT).show();
									}
		...
		scan.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ZxingActivity.this, MipcaActivityCapture.class);
