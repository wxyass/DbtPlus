...
import et.tsingtaopad.syssetting.zxing.camera.CameraManager;
import et.tsingtaopad.syssetting.zxing.decoding.CaptureActivityHandler;
import et.tsingtaopad.syssetting.zxing.decoding.InactivityTimer;
import et.tsingtaopad.syssetting.zxing.decoding.RGBLuminanceSource;
import et.tsingtaopad.syssetting.zxing.view.ViewfinderView;

/**
 * 
 * 项目名称：营销移动智能工作平台 </br>
 * 文件名：MipcaActivityCapture.java</br>
 * 作者：yangwenmin   </br>
 * 创建时间：2016-12-5</br>      
 * 功能描述: 扫描二维码页面</br>      
 * 版本 V 1.0</br>               
...
//					mIntent1.setAction(Intent.ACTION_OPEN_DOCUMENT);
	...
	private void onResultHandler(String resultString, Bitmap bitmap){
		...
		Intent intent = new Intent(MipcaActivityCapture.this,LoadAppActivity.class);
...
//		playBeepSoundAndVibrate();
		...
		if (resultString.equals("")) {
			...
			onResultHandler(resultString, barcode);// 跳转到显示的页面
		}
		MipcaActivityCapture.this.finish();
	}
